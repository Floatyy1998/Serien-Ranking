...
import { 
  ArrowBack, Star, Movie as MovieIcon, Tv as TvIcon, Public
...
export const MobilePublicProfilePage: React.FC = () => {
      ...
      try {
        ...
        if (users) {
          for (const [userId, userData] of Object.entries(users)) {
            ...
            console.log(`Checking user ${userId}: publicProfileId=${user.publicProfileId}, isPublicProfile=${user.isPublicProfile}`);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            flex: 1,
            padding: '12px',
            background: activeTab === 'series' ? 'var(--color-primary)' : 'var(--color-background-surface)',
        ...
        <button
          ...
          style={{
            flex: 1,
            padding: '12px',
            background: activeTab === 'movies' ? 'var(--color-primary)' : 'var(--color-background-surface)',
      ...
      {/* Items Grid */}
      <div style={{ padding: window.innerWidth >= 768 ? '0 40px' : '0 20px', maxWidth: '1200px', margin: '0 auto' }}>
        {currentItems.length === 0 ? (
          <div style={{
            ...
            <p style={{ fontSize: '16px', opacity: 0.7, maxWidth: '400px', margin: '0 auto' }}>
              {profileName || 'Dieser Nutzer'} hat noch keine {activeTab === 'series' ? 'Serien' : 'Filme'} zu seiner Liste hinzugefügt oder bewertet
            </p>
          </div>
        ) : (
          <div style={{ 
