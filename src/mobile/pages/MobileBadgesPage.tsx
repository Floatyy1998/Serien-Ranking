      ...
      <div className="mobile-badges-page">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '50px' }}>
          <div className="loading-spinner">
            <EmojiEvents
              style={{ fontSize: 48, color: '#667eea', animation: 'pulse 2s infinite' }}
            />
          </div>
        </div>
      </div>
          ...
          >
            {cat === 'all' ? (
              <>
                <EmojiEvents />
                <span>Alle</span>
                <Chip label={stats.earned} size="small" className="category-count" />
              </>
            ) : (
              <>
                {categoryIcons[cat]}
            ...
            return (
              ...
              >
                ...
                <div className="badge-icon-container">
                  ...
                  {earned && <CheckCircle className="earned-indicator" />}
                  {!earned && <Lock className="locked-indicator" />}
                </div>
                ...
                <div className="badge-info">
                  ...
                  <div className="badge-rarity">
                    {[...Array(4)].map((_, i) => (
                      <Star key={i} className={i < getRarityStars(badge.rarity) ? 'filled' : ''} />
                    ))}
                  </div>
