      ...
      <div
        style={{
          ...
          background: `
            ...
            radial-gradient(ellipse 60% 40% at 80% 10%, #8b5cf625, transparent),
            radial-gradient(ellipse 50% 30% at 20% 20%, #06b6d420, transparent)
          `,
          pointerEvents: 'none',
          zIndex: 0,
        }}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              >
                Dein Viewing-Universum in Zahlen
              </p>
            </div>
          </div>
        </header>
