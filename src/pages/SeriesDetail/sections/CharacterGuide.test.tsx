...
import type { CharacterDescription } from '../../../hooks/series/useCharacterDescriptions';
...
vi.mock('../../../hooks/platform/useTextToSpeech', () => ({
  useTextToSpeech: () => ({ state: 'idle', speak: vi.fn(), stop: vi.fn() }),
}));
vi.mock('../../../components/ui/input/SpeakButton', () => ({ SpeakButton: () => <span /> }));
