    ...
    >
      ...
      <div
        style={{
          ...
          height: '400px',
          background: `
            radial-gradient(ellipse 80% 50% at 50% -20%, ${currentTheme.status.success}30, transparent),
          ...
          <div style={{ flex: 1 }}>
            <h1
              style={{
                ...
                fontWeight: 800,
                margin: 0,
                background: `linear-gradient(135deg, ${currentTheme.text.primary}, ${currentTheme.status.success})`,
              ...
              >
                <motion.div
                  ...
                  style={{
                    width: '48px',
                    height: '48px',
                    border: `3px solid ${currentTheme.status.success}20`,
                    borderTop: `3px solid ${currentTheme.status.success}`,
                    borderRadius: '50%',
                    margin: '0 auto 20px',
                  }}
                />
