...
import { hapticCelebrate, hapticSuccess } from '../../../lib/interaction/haptics';
...
import { getStreakStatus, getShieldCooldown } from '../hooks/watchStreakHelpers';
import type { WatchStreakData, ActivePetInfo } from '../hooks/watchStreakHelpers';
import { StreakShieldDialog } from '../sheets/StreakShieldDialog';
      ...
      <div style={{ margin: '0 20px', width: 'calc(100% - 40px)' }}>
        <div
          ...
          style={{
            ...
            borderLeft: `1px solid ${currentTheme.border.default}`,
            ...
            >
              <div
                style={{
                  ...
                  borderRight: `1px solid ${flameColor}30`,
                  borderBottom: `1px solid ${flameColor}30`,
                  borderLeft: `1px solid ${flameColor}30`,
                  display: 'flex',
