...
// Memo: StatCard sits in a grid that re-renders on any HomePage state change
// (notifications, friend activity, …). Without memo each unrelated update
// re-renders all four cards. Props are scalar/stable, so memo is safe.
