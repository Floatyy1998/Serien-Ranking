...
vi.mock('../cards/ProactiveRecapCard', () => ({
  ProactiveRecapCard: () => <div data-testid="recap-card" />,
}));
vi.mock('../../../components/ui/notification/ProviderChangeNotification', () => ({
  ProviderChangeNotification: () => <div data-testid="provider-card" />,
}));
vi.mock('../../../components/ui/notification/UnsubscribedNewSeasonNotification', () => ({
  UnsubscribedNewSeasonNotification: () => <div data-testid="unsub-card" />,
}));
vi.mock('../../../components/ui/notification/CarouselNotification', () => ({
