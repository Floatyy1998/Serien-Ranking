...
export const HomePage: React.FC = () => {
  ...
  const getNotificationIcon = (icon: string) => {
    switch (icon) {
      case 'tv':
        return <Tv style={{ fontSize: '18px', color: currentTheme.primary }} />;
      case 'movie':
        return <MovieIcon style={{ fontSize: '18px', color: currentTheme.status.error }} />;
      case 'star':
        return <Star style={{ fontSize: '18px', color: currentTheme.status.warning }} />;
      case 'watchlist':
        return <PlayCircle style={{ fontSize: '18px', color: currentTheme.primary }} />;
      case 'person':
        return <PersonAdd style={{ fontSize: '18px', color: currentTheme.status.success }} />;
      case 'chat':
        return <ChatBubbleOutline style={{ fontSize: '18px', color: currentTheme.primary }} />;
      case 'heart':
        return <Favorite style={{ fontSize: '18px', color: '#ff6b6b' }} />;
      case 'flag':
        return <Flag style={{ fontSize: '18px', color: currentTheme.status.warning }} />;
      case 'announcement':
        return <NewReleases style={{ fontSize: '18px', color: '#a855f7' }} />;
      default:
        return <Notifications style={{ fontSize: '18px', color: currentTheme.text.muted }} />;
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '0 16px 16px' }}
        >
          <p
            style={{
              fontSize: '17px',
                ...
                {unifiedNotifications.map((item, index) => (
                  <motion.div
                    ...
                    style={{
                      ...
                      borderBottom:
                        index < unifiedNotifications.length - 1
