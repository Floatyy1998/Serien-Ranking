...
interface TrendingRankCardProps {
  item: MediaItem;
  /** 0-basierter Index im Carousel — daraus wird die Rank-Nummer (index + 1). */
  index: number;
  cardWidth: string;
}

/** Trending — Disney+ inspired cinematic cards mit Corner-Cutout-Rank. */
export function TrendingRankCard({ item, index, cardWidth }: TrendingRankCardProps) {
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              >
                <defs>
                  <linearGradient id={`corner-grad-${index}`} x1="0%" y1="0%" x2="100%" y2="100%">
