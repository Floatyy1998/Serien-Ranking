      ...
      <div style={{ paddingBottom: '100px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            <GradientText
              as="span"
              from={getCompatibilityColors(result.overallMatch).from}
              to={getCompatibilityColors(result.overallMatch).to}
              style={{
                fontSize: 80,
                fontWeight: 900,
                lineHeight: 1,
        ...
        <div style={{ padding: '0 16px 20px', overflow: 'visible' }}>
          ...
          >
            {[
              ...
              {
                id: 'series',
                label: `Serien (${result.seriesOverlap.sharedSeries.length})`,
                color: ACCENT_COLORS.series,
                icon: <Tv style={{ fontSize: 16 }} />,
              },
              {
                id: 'movies',
                label: `Filme (${result.movieOverlap.sharedMovies.length})`,
                color: ACCENT_COLORS.movies,
                ...
                {result.seriesOverlap.sharedSeries.length > 0 ? (
                  <>
                    ...
                    >
                      ...
                      {result.seriesOverlap.sharedSeries.filter(
                        (s) => s.ratingDiff !== undefined && s.ratingDiff < 1
                      ).length > 0 && (
                        <span
                          style={{
                            marginLeft: 'auto',
                ...
                {result.movieOverlap.sharedMovies.length > 0 ? (
                  <>
                    ...
                    >
                      ...
                      {result.movieOverlap.sharedMovies.filter(
                        (m) => m.ratingDiff !== undefined && m.ratingDiff < 1
                      ).length > 0 && (
                        <span
                          style={{
                            marginLeft: 'auto',
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: 14, color: USER_COLOR, fontWeight: 600 }}>
                      {userName}
                    </span>
                  </div>
                  <div
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: 14, color: FRIEND_COLOR, fontWeight: 600 }}>
                      {friendName}
                    </span>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    {
                      result.genreMatch.sharedGenres.filter(
                        (g) => g.userPercentage > 0 || g.friendPercentage > 0
                      ).length
                    }{' '}
                    Genres
