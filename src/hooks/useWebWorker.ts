...
export interface WebWorkerOptions<TInput> {
  ...
  data: TInput | null;
  /** Dep-String für Vergleiche (verhindert unnötige Worker-Nachrichten) */
  depsKey: string;
  /** Optionales Debounce-Intervall in ms (default: 0 = kein Debounce) */
  debounceMs?: number;
  /** Ob Worker-Daten gesendet werden sollen (false = überspringen) */
  enabled?: boolean;
}
...
/**
 * Generischer Hook für Web Worker Kommunikation.
 * Kapselt Worker-Lifecycle (Initialisierung, Cleanup), Debouncing
 * und Deduplizierung von Nachrichten über depsKey.
 *
