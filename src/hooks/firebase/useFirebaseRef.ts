...
/**
 * Abonniert einen Firebase Realtime Database Pfad und gibt die Daten reaktiv zurueck.
 * Der Listener wird automatisch beim Unmount oder bei Pfadaenderung bereinigt.
 *
