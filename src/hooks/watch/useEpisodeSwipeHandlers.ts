...
import { shouldTriggerQuickRate, useQuickSeasonRating } from '../rating/useQuickSeasonRating';
import type { Series } from '../../types/Series';
import type { TodayEpisode } from '../data/useWebWorkerTodayEpisodes';
import { useWebWorkerTodayEpisodes } from '../data/useWebWorkerTodayEpisodes';
import {
  buildEpisodeWatchedUpdates,
  buildEpisodeUnwatchUpdates,
} from '../../lib/watch/compactWatch';
    ...
    async (item: ContinueWatchingItem, swipeDirection: 'left' | 'right' = 'right') => {
      ...
      try {
        const snap = await markEpisodeWatchedInFirebase(
          ...
          item.nextEpisode.absoluteNumber
        );
