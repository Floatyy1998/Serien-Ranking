...
const dict: Record<string, string> = {
  ...
  'Alles, was du schaust.': 'Everything you watch.',
  Begleiter: 'Companion',
  Wrapped: 'Wrapped',
  Streaming: 'Streaming',
  ...
  // GuestOnboardingPage — Sichern (alt)
  'Bereit, wenn du es bist.': 'Ready when you are.',
  'Melde dich an — deine Auswahl und dein Begleiter warten schon.':
    'Sign in — your picks and your companion are ready.',
  'mit e-mail registrieren': 'sign up with email',
  '← zurück zur Auswahl': '← back to your picks',

  // PetHatchStep
  'dein Begleiter': 'your companion',
  'Dein Begleiter erwacht': 'Your companion awakens',
  'Er levelt mit jeder Folge, die du schaust. Gib ihm einen Namen und eine Gestalt.':
    'It levels up with every episode you watch. Give it a name and a form.',
  'Name deines Begleiters …': 'Your companion’s name …',
  Gestalt: 'Form',
