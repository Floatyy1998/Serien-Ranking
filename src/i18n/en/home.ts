...
const dict: Record<string, string> = {
  ...
  // Heute-Abend-Picker
  'Heute Abend': 'Tonight',
  'Ein Vorschlag nach Zeit und Stimmung': 'One pick for your time and mood',
  'Heute Abend: Ein Vorschlag nach Zeit und Stimmung': 'Tonight: one pick for your time and mood',
  'Was schaust du heute Abend?': 'What are you watching tonight?',
  'Wie viel Zeit hast du?': 'How much time do you have?',
  'Wonach ist dir?': 'What are you in the mood for?',
  Egal: 'Any',
  '30 Min': '30 min',
  '1 Std': '1 hr',
  '2 Std': '2 hrs',
  ...
  'Nichts passt zu den Filtern — stell Zeit oder Stimmung um.':
    'Nothing matches the filters — adjust time or mood.',
  'Los geht’s': 'Let’s go',
  'Anderer Vorschlag': 'Another pick',
