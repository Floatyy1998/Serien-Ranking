...
const dict: Record<string, string> = {
  'S{s} E{e}{name} als gesehen markieren': 'Mark S{s} E{e}{name} as watched',
  // Gemeinsam
  Zurück: 'Back',
  ...
  'Spoiler-Schutz — tippen zum Anzeigen': 'Spoiler shield — tap to reveal',
  'Folge {n}': 'Episode {n}',
  ...
  Handlung: 'Plot',
  'Reihe komplett!': 'Collection complete!',
