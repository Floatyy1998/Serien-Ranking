    ...
    case 'sunrise':
      return (
        <svg {...iconProps}>
          ...
          <path d="M12 2v4M4.22 10.22l2.83 2.83M1 17h4M19 17h4M16.95 13.05l2.83-2.83" strokeLinecap="round"/>
...
export const AchievementsSlide: React.FC<AchievementsSlideProps> = ({
  achievements,
}) => {
