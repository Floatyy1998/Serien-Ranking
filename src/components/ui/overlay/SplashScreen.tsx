...
import { APP_READY_EVENT, APP_READY_KEYS, countAppReady } from '../../../services/app/appReady';
        ...
        <LogoSVG viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="goldGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#ef6f8a" stopOpacity="0.9" />
              <stop offset="50%" stopColor="#f2914f" stopOpacity="1" />
              <stop offset="100%" stopColor="#f2a648" stopOpacity="0.9" />
            </linearGradient>
          </defs>
