...
export default [
  ...
  prettierConfig,
  {
    ...
    rules: {
      ...
      // flagt es als falsch positiv. Echte Anti-Patterns (initial-load aus
      // localStorage, mirror-state) wurden separat gefixt; restliche Treffer
      // sind Noise → off.
      'react-hooks/set-state-in-effect': 'off',
      // Compiler-Diagnostic: zeigt Stellen, wo der React Compiler manuelles
      // useMemo/useCallback nicht erhalten kann. Informativ, kein Bug → off.
